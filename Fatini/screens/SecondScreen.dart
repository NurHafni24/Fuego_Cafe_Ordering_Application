                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            MenuFood(image: "americano", name: "Americano"),
                            MenuFood(image: "frappe", name: "Strawberry Frappe"),
                          ],
                        ),
                      ),
                      addVerticalSpace(padding),
                      Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            MenuFood(image: "hotchoco", name: "Hot Chocolate"),
                            MenuFood(image: "latte", name: "Latte"),
                          ],
                        ),
                      ),
                      addVerticalSpace(padding),
                      Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            MenuFood(image: "orange", name: "Orange Juice"),
                            MenuFood(image: "oreo", name: "Oreo Milkshake"),
                          ],
                        ),
                      ),
                      addVerticalSpace(padding),
